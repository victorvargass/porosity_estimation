...
if __name__ == "__main__":
    ...
    S = 0.0315  # Distance between microphones (m)
    L = 0.1115    # Distance between reference microphone and sample (m)
    D = 0.0986 # Tube diameter (m)

    humidity_percentage = 0.5

    freq_min, freq_max = 295, 3000
    y_min, y_max = 0, 1
    ...
    freqs = fs * np.arange(N//2 + 1) / N  # Vector de frecuencias
